	...
	<div class="content-wrapper">
		...
		<section class="section-padding2">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h2 class="section-title2">Planning</h2> </div>
				</div>
				<div class="row">
					<div class="col-md-8">
						...
						<div class="row mb-30">
							<div class="col-md-12 gallery-item">
								<a href="img/services/7.jpg" title="Planning" class="img-zoom">
									<div class="gallery-box">
										<div class="gallery-img"> <img src="img/services/7.jpg" class="img-fluid mx-auto d-block" alt="work-img"> </div>
									</div>
								</a>
							</div>
						</div>
						...
						<aside class="sidebar blog-sidebar">
							<div class="sidebar-widget services">
								<div class="widget-inner">
									...
									<ul>
										<li><a href="architecture.php">Achitecture</a></li>
										<li><a href="interior-design.php">Interior Design</a></li>
										<li><a href="urban-design.php">Urban Design</a></li>
										<li class="active"><a href="planning.php">Planning</a></li>
										<li><a href="3d-modelling.php">3D Modelling</a></li>
										<li><a href="decor-plan.php">Decor Plan</a></li>
									</ul>
								</div>
							</div>
						</aside>
