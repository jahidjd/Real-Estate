	...
	<div class="content-wrapper">
		...
		<section class="section-padding2">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h2 class="section-title2">Stonya Villa</h2>
					</div>
				</div>
				<div class="row">
					<div class="col-md-8">
					...
					<div class="col-md-4">
						<p><b>Year : </b> 2022</p>
						<p><b>Company : </b> OTT International</p>
						<p><b>Project Name : </b> Stonya Villa</p>
						<p><b>Location : </b>Bandarban, Bangladesh</p>
					</div>
				</div>
				<div class="row mt-30">
					<?php
					...
					<div class="col-md-12">
						<div class="d-sm-flex align-items-center justify-content-between">
							<div class="projects-prev-next-left">
								<a href="armada-center.php"> <i class="ti-arrow-left"></i> Previous Project</a>
							</div> <a href="projects4.php"><i class="ti-layout-grid3-alt"></i></a>
							<div class="projects-prev-next-right"> <a href="prime-hotel.php">Next Project <i class="ti-arrow-right"></i></a> </div>
						</div>
					</div>
				</div>
			</div>
