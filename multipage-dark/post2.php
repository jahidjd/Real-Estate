...
<body>
	...
	<div class="content-wrapper">
		...
		<section class="pb-90">
			<div class="container">
				<div class="row">
					<div class="col-md-12"> <img src="img/slider/2.jpg" class="mb-30" alt="">
						<h2 class="section-title2">Modernism in Architecture</h2>
					...
					<div class="row">
						...
						<div class="col-md-7">
							<div class="bauen-post-comment-wrap">
								<div class="bauen-user-comment"> <img src="img/team/2.jpg" alt=""> </div>
								<div class="bauen-user-content">
									<h3>Jesica Misse<span> 29 October 2022</span></h3>
									<p>Photography ultricies nibh non dolor maximus sceleue inte molliser faubs neque nec tincidunte aliquam erat volutpat. Praeser tempor malade yap. </p> <a class="bauen-repay" href="#">Reply<i class="ti-back-left"></i></a> </div>
							</div>
						</div>
						<!-- Contact Form -->
