    ...
    <div class="content-wrapper">
        ...
        <section class="bauen-blog section-padding2">
            <div class="container">
                ...
                <div class="row">
                    <?php while ($b = $blog->fetch_assoc()) { ?>
                        <div class="col-md-6">
                            <div class="item">
                                <div class="position-re o-hidden"> <img src="../NORA_FASHION/photo/<?php echo $b['blog_photo'] ?>" alt=""> </div>
                                <div class="con"> <span class="category">
                                        <a href="blog.php?id=<?php echo $b['id'] ?>"><?php echo $b['category_name'] ?> </a> - <?php echo $b['date'] ?>
                                    </span>
                                    <h5><a href="post.php?id=<?php echo $b['id'] ?>"><?php echo $b['blog_category'] ?></a></h5>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <ul class="bauen-pagination-wrap align-center mb-30 mt-30">
                            <li><a href="blog.php#"><i class="ti-angle-left"></i></a></li>
                            <li><a href="blog.php#">1</a></li>
                            <li><a href="blog.php#" class="active">2</a></li>
                            <li><a href="blog.php#">3</a></li>
                            <li><a href="blog.php#"><i class="ti-angle-right"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
