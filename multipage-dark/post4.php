    ...
    <div class="content-wrapper">
        ...
        <section class="pb-90">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <img src="img/slider/4.jpg" class="mb-30" alt="">
                        <h2 class="section-title2">Modern Architecture Buildings</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="bauen-post-comment-wrap">
                                <div class="bauen-user-comment"> <img src="img/team/4.jpg" alt=""> </div>
                                <div class="bauen-user-content">
                                    <h3>Emily Misse<span> 29 October 2022</span></h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 abot">
                            <div class="social-icon">
                                <a href="index.php"><i class="ti-facebook"></i></a>
                                <a href="index.php"><i class="ti-twitter"></i></a>
                                <a href="index.php"><i class="ti-instagram"></i></a>
                                <a href="index.php"><i class="ti-pinterest"></i></a>
                            </div>
                        </div>
                        <div class="col-md-4">
