...
<body>
    ...
    <div class="content-wrapper">
        ...
        <!-- Services Page -->
        <?php
        $service = $conn->query("SELECT * FROM service WHERE status='active' AND id=" . $_GET['id']);
        $s = $service->fetch_assoc();
        ...
        <section class="section-padding2">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="section-title2"><?php echo $s['title'] ?></h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <p><?php echo $s['title'] ?> non lorem ac erat suscipit bibendum. Nulla facilisi sedeuter nunc volutpat molli sapien veconseyer turpeutionyer masin libero sempe. Fusceler mollis augue sit amet hendrerit vestibulum. Duisteyerionyer venenatis lacus.</p>
                        ...
                        <div class="row mb-30">
                            ...
                            <div class="col-md-12 gallery-item">
                                <a href="../NORA_FASHION/photo/<?php echo $s['photo'] ?>" title="<?php echo $s['title'] ?>" class="img-zoom">
                                    <div class="gallery-box">
                                        <div class="gallery-img"> <img src="../NORA_FASHION/photo/<?php echo $s['photo'] ?>" class="img-fluid mx-auto d-block" alt="<?php echo $s['title'] ?>"> </div>
                                    </div>
                                </a>
                            </div>
