...
<body>
	...
	<div class="content-wrapper">
		...
		<section class="pb-90">
			<div class="container">
				<div class="row">
					<div class="col-md-12"> <img src="img/slider/3.jpg" class="mb-30" alt="">
						<h2 class="section-title2">Postmodern Architecture</h2>
					...
					<div class="row">
						...
						<div class="col-md-7">
							<div class="bauen-post-comment-wrap">
								<div class="bauen-user-comment"> <img src="img/team/3.jpg" alt=""> </div>
								<div class="bauen-user-content">
									<h3>Martin Misse<span> 29 October 2022</span></h3>
