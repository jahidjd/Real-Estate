    ...
    <div class="content-wrapper">
        ...
        <section class="section-padding2">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="section-title2">Armada Center</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-8">
                    ...
                    <div class="col-md-12">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <div class="projects-prev-next-left">
                                <a href="cotton-house.php"> <i class="ti-arrow-left"></i> Previous Project</a>
                            </div> <a href="projects4.php"><i class="ti-layout-grid3-alt"></i></a>
                            <div class="projects-prev-next-right"> <a href="stonya-villa.php">Next Project <i class="ti-arrow-right"></i></a> </div>
                        </div>
                    </div>
                </div>
            </div>
