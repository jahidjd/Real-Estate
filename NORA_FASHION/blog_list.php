...
?>
    ...
    <img class="animation__shake" src="dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
            ...
            $b = $conn->query('SELECT * FROM blog_category');
                ...
                <form action="add_blog.php" method="POST" enctype="multipart/form-data">
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td>
                                <select name="b_category_id" id="" class="form-control">
                                    <option value="">Select Blog Category</option>
                                    <?php while ($blog = $b->fetch_assoc()) { ?>
                                        <option value="<?php echo $blog['id'] ?>"><?php echo $blog['blog_category'] ?></option>
                                    <?php } ?>
                                </select>
                            </td>
                        ...
                        <tr>
                            <td>Blog Details</td>
                            <td colspan="3">
                                <textarea name="blog_details" id="" cols="30" rows="10" class="form-control"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>Date</td>
                            <td><input type="date" name="date" class="form-control"></td>
                            <td colspan="1"><input type="submit" class="btn btn-block btn-info"></td>
                        </tr>
                        <tr>
            ...
            <?php
            $conn  = new mysqli('localhost', 'root', '', 'nora');
            $b = $conn->query('SELECT blog.*,blog_category.blog_category FROM `blog`JOIN blog_category on blog.blog_category_id=blog_category.id');
            $ss = 0;
                    ...
                    <tbody>
                        <?php while ($blog = $b->fetch_assoc()) { ?>
                            <tr>
                                <td><?php echo ++$ss; ?></td>
                                <td>
                                    <img src="photo/<?php echo $blog['blog_photo'] ?>" alt="" width="100px">
                                </td>
                                <td><?php echo $blog['blog_category']; ?></td>
                                <td><?php echo $blog['blog_details']; ?></td>
                                <td><?php echo $blog['date']; ?></td>
                                <td>
                                    <a href="blog_edit.php?id=<?php echo $blog['id']; ?>" class="btn btn-success btn-xs">Edit</a>
                                    <a href="blog_delete.php?id=<?php echo $blog['id']; ?>" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure!!')">Delete</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
