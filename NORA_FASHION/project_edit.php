...
?>
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
      ...
      $pro = $conn->query("select * from projects where id=" . $_GET['id']);
      $project = $pro->fetch_assoc();
        ...
        <form action="update_project.php" method="post" enctype="multipart/form-data">
          ...
          <table class="table table-bordered">
            <tr>
              ...
              <td>Project Title</td>
              <td><input type="text" name="p_title" class="form-control" value="<?php echo $project['title'] ?>"></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="3">
                <textarea name="details" id="" cols="30" rows="10" class='form-control'><?php echo $project['details'] ?></textarea>
              </td>
            </tr>
            <tr>
              <td>Photo</td>
