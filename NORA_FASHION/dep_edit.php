...
?>
    ...
    <img class="animation__shake" src="dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
            ...
            $d =  $conn->query("SELECT * FROM department where id=" . $_GET['id']);
            $dep = $d->fetch_assoc();
            ?>
                ...
                <form action="update_dep.php" method="POST">
                    ...
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td><input type="text" name="d_name" id="" class="form-control" value="<?php echo $dep['department_name'] ?>"></td>
                        </tr>
                        <tr>
                            <td colspan="2"><input type="submit" class="btn btn-info btn-block" value="Update"></td>
                        </tr>
                    </table>
                </form>
            </div>
