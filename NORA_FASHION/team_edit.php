...
?>
    ...
    <img class="animation__shake" src="dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
            ...
            $t = $conn->query("SELECT * FROM team where id=" . $_GET['id']);
            $team = $t->fetch_assoc();
            ...
            <div class="container">
                ...
                <form action="update_team.php" method="POST" enctype="multipart/form-data">
                    ...
                    <table class="table table-bordered">
                        <tr>
                            <td>Name</td>
                            <td colspan="3"><input type="text" name="name" class="form-control" value="<?php echo $team['name'] ?>"></td>
                            <td colspan="2">
                                <select name="deprt" id="" class="form-control">
                                    <option value="">Select Department</option>
                                    <?php while ($da = $d->fetch_assoc()) { ?>
                                        <option value="<?php echo $da['id'] ?>"><?php echo $da['department_name'] ?></option>
                                    <?php } ?>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td>Age</td>
                            <td><input type="text" name="age" class="form-control" value="<?php echo $team['age'] ?>"></td>
                            <td>Contact</td>
                            <td><input type="text" name="contact" class="form-control" value="<?php echo $team['contact'] ?>"></td>
                            <td>Skill</td>
                            <td><input type="text" name="skill" class="form-control" value="<?php echo $team['skill'] ?>"></td>
                        </tr>
                        <tr>
                            <td>Email</td>
                            <td colspan="3"><input type="text" name="email" class="form-control" value="<?php echo $team['email'] ?>"></td>
                            <td>Experience</td>
                            <td><input type="text" name="exp" class="form-control" value="<?php echo $team['experience'] ?>"></td>
                        </tr>
                        <tr>
                            <td>History</td>
                            <td colspan="5">
                                <textarea name="history" id="" cols="30" rows="10" class="form-control"><?php echo $team['history'] ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>Photo</td>
                            <td colspan="2"><input type="file" name="photo" class="form-control"></td>
