...
?>
    ...
    <img class="animation__shake" src="dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
            ...
            $p = $conn->query("SELECT * FROM process WHERE id=" . $_GET['id']);
            $pro = $p->fetch_assoc();
            ?>
            <div class="container">
                ...
                <form action="update_process.php" method="POST" enctype="multipart/form-data">
                    ...
                    <table class="table table-bordered">
                        <tr>
                            <td>Process Name</td>
                            <td><input type="text" name="p_name" class="form-control" value="<?php echo $pro['p_name'] ?>"></td>
                            <td>Number</td>
                            <td><input type="text" name="number" class="form-control" value="<?php echo $pro['number'] ?>"></td>
                        </tr>
                        <tr>
                            <td>Details</td>
                            <td colspan="3">
                                <textarea name="details" id="" cols="30" rows="10" class="form-control"><?php echo $pro['details'] ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>Icon</td>
                            <td><input type="text" name="icon" class="form-control" value="<?php echo $pro['icon'] ?>"></td>
                            <td>Arrow</td>
