...
?>
    ...
    <img class="animation__shake" src="dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
            ...
            $bl = $conn->query("SELECT * FROM blog_category where id=" . $_GET['id']);
            $ser = $bl->fetch_assoc();
            ...
            ?>
            <div class="container">
                <h1>Update blog ctategory</h1>
                <form action="update_blog_category.php" method="POST">
                    <input type="hidden" name='id' value="<?php echo $_GET['id'] ?>">
                    <table class="table table-bordered">
                        <tr>
                            <td>Category Name</td>
                            <td><input type="text" name="name" class="form-control" value="<?php echo $ser['blog_category'] ?>"></td>
                            <td>Blog Name</td>
                            <td><input type="text" name="blog_name" class="form-control" value="<?php echo $ser['category_name'] ?>"></td>
                        </tr>
                        <tr>
                            <td colspan="4"><input type="submit" class="btn btn-info btn-block" value="Update"></td>
                        </tr>
                    </table>
                </form>
            </div>
