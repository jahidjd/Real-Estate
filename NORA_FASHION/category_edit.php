...
?>
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
      ...
      $d = $conn->query("select * from project_category where id=" . $_GET['id']);
      $data = $d->fetch_assoc();
      ...
      <div class="container">
        ...
        <form action="update_category.php" method="post">
          <table class="table table-bordered">
            ...
            <tr>
              <td>Category Name</td>
              <td><input type="text" name="category" class="form-control" value="<?php echo $data['title'] ?>"></td>
              <td>Name</td>
              <td><input type="text" name="c_name" class="form-control" value="<?php echo $data['c_name'] ?>"></td>
            </tr>
            <tr>
              <td>Short Details</td>
              <td colspan="3">
                <textarea name="short_details" id="" cols="30" rows="10" class="form-control"><?php echo $data['short_details'] ?></textarea>
              </td>
            </tr>
            <tr>
