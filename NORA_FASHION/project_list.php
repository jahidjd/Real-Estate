...
?>
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
      ...
      $d = $conn->query("select * from project_category");
      ...
      <div class="container">
        ...
        <form action="add_project.php" method="post" enctype="multipart/form-data">
          <table class="table table-bordered">
            <tr>
              <td>
                <select name="category_title" id="" class="form-control">
                  ...
                  <?php while ($data = $d->fetch_assoc()) { ?>
                    <option value="<?php echo $data['id'] ?>"><?php echo $data['title'] ?></option>
                  <?php } ?>
                </select>
              </td>
              <td>Project Title</td>
              <td><input type="text" name="p_title" class="form-control"></td>
            </tr>
            <tr>
            ...
            <tr>
              <td colspan="4"><input type="submit" value="Insert" class="btn btn-success btn-block"></td>
            </tr>
          </table>
        </form>
      </div>
      ...
      $dt = $conn->query("SELECT projects.*, project_category.title as c_name FROM projects JOIN project_category on projects.category_id=project_category.id");
      ...
      <div class="container">
        <h1>Project List</h1>
        <table class="table table-bordered tanle-hover">
          <thead>
            <tr>
              <th>SL</th>
              <th>Category Name</th>
          ...
          <tbody>
            <?php while ($dta = $dt->fetch_assoc()) { ?>
              <tr>
                <td><?php echo ++$s ?></td>
                <td><?php echo $dta['c_name'] ?></td>
                <td><?php echo $dta['title'] ?></td>
                <td><?php echo $dta['details'] ?></td>
                <td>
                  <img src="photo/<?php echo $dta['photo'] ?>" style="width:100px;" alt="">
                </td>
                <td><?php echo $dta['status'] ?></td>
                <td>
                  <a href="project_edit.php?id=<?php echo $dta['id'] ?>" class="btn btn-success">Edit</a>
                  <a href="project_delete.php?id=<?php echo $dta['id'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure!!')">Delete</a>
