...
?>
    ...
    <img class="animation__shake" src="dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
                ...
                <form action="add_service.php" method="post" enctype="multipart/form-data">
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td>Service Photo</td>
                            <td><input type="file" name="s_photo" class="form-control"></td>
                        </tr>
                        <tr>
                            <td>Details</td>
                            <td colspan="3">
                                <textarea name="s_details" id="" cols="30" rows="10" class="form-control"></textarea>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2"><input type="submit" class="btn btn-block btn-info" value="Insert"></td>
                        </tr>
                    </table>
                </form>
            </div>
            ...
            <div class="container">
                ...
                $sr = $conn->query("SELECT * FROM service");
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <?php while ($service = $sr->fetch_assoc()) { ?>
                            <tr>

                                <td><?php echo $service['number'] ?></td>
                                <td><?php echo $service['title'] ?></td>
                                <td>
                                    <img src="photo/<?php echo $service['photo'] ?>" style="width:100px" alt="">

                                </td>
                                <td><?php echo $service['details'] ?></td>
                                <td><?php echo $service['status'] ?></td>
                                <td>
                                    <img src="photo/<?php echo $service['service_icon'] ?>" style="width:100px" alt="">
                                </td>
                                <td>
                                    <a href="service_edit.php?id=<?php echo $service['id'] ?>" class="btn btn-success btn-xs ">Edit</a>
                                    <a href="service_delete.php?id=<?php echo $service['id'] ?>" class="btn btn-danger btn-xs " onclick="return confirm('are you sure!!')">Delete</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
