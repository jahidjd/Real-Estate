...
?>
    ...
    <img class="animation__shake" src="dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
            ...
            $bl = $conn->query('SELECT * FROM blog where blog.id=' . $_GET['id']);
            $blogs = $bl->fetch_assoc();
                ...
                <form action="update_blog.php" method="POST" enctype="multipart/form-data">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>Blog Details</td>
                            <td colspan="3">
                                <textarea name="blog_details" id="" cols="30" rows="10" class="form-control"><?php echo $blogs['blog_details'] ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>Date</td>
                            <td><input type="date" name="date" class="form-control" value="<?php echo $blogs['date'] ?>"></td>
