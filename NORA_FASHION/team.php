...
?>
    ...
    <img class="animation__shake" src="dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
            ...
            <div class="container">
                ...
                <form action="add_team.php" method="POST" enctype="multipart/form-data">
                    <table class="table table-bordered">
                        <tr>
                            <td>Name</td>
                            <td colspan="3"><input type="text" name="name" class="form-control"></td>
                            <td colspan="2">
            ...
            <?php
            $conn = new mysqli('localhost', 'root', '', 'nora');
            $d =  $conn->query("SELECT team.*,department.department_name FROM team join department on team.department_id=department.id");
            $sl = 0;
            ...
            <div class="container">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php while ($team = $d->fetch_assoc()) { ?>
                            <tr>
                                <td><?php echo ++$sl ?></td>
                                <td><?php echo $team['name'] ?></td>
                                <td><?php echo $team['department_name'] ?></td>
                                <td><?php echo $team['age'] ?></td>
                                <td><?php echo $team['contact'] ?></td>
                                <td><?php echo $team['email'] ?></td>
                                <td><?php echo $team['skill'] ?></td>
                                <td><?php echo $team['experience'] ?></td>
                                <td>
                                    <img src="photo/<?php echo $team['photo'] ?>" style="width:100px;" alt="">
                                </td>
                                <td><?php echo $team['history'] ?></td>
                                <td>
                                    <a href="team_edit.php?id=<?php echo $team['id'] ?>" class="btn btn-success btn-xs">Edit</a>
                                    <a href="team_delete.php?id=<?php echo $team['id'] ?>" class="btn btn-danger btn-xs" onclick="return confirm('are you sure!!')">Delete</a>
