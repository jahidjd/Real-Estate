...
?>
    ...
    <img class="animation__shake" src="dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
                ...
                <form action="add_process.php" method="POST" enctype="multipart/form-data">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>Arrow</td>
                            <td><input type="file" name="arrow" class="form-control"></td>
                        </tr>
                        <tr>
            ...
            $p = $conn->query("SELECT * FROM process");
            ...
            <div class="container">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php while ($process = $p->fetch_assoc()) { ?>
                            <tr>
                                <td><?php echo $process['number'] ?></td>
                                <td><?php echo $process['p_name'] ?></td>
                                <td><?php echo $process['icon'] ?></td>
                                <td><?php echo $process['arrow'] ?></td>
                                <td><?php echo $process['details'] ?></td>
                                <td>
                                    <a href="process_edit.php?id=<?php echo $process['id'] ?>" class="btn btn-info btn-xs">Edit</a>
                                    <a href="process_delete.php?id=<?php echo $process['id'] ?>" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure!!')">Delete</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
