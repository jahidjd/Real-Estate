                ...
                <form action="add_dep.php" method="POST">
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td><input type="text" name="d_name" id="" class="form-control"></td>
                        </tr>
                        <tr>
                            <td colspan="2"><input type="submit" class="btn btn-info btn-block"></td>
                        </tr>
                    </table>
                </form>
            </div>
            <div class="container">
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        $sl = 0;
                        while ($dpt = $d->fetch_assoc()) {
                        ?>
                            <tr>
                                <td><?php echo ++$sl ?></td>
                                <td><?php echo $dpt['department_name'] ?></td>
                                <td>
                                    <a href="dep_edit.php?id= <?php echo $dpt['id'] ?>" class="btn btn-success btn-xs">Edit</a>
                                    <a href="dep_delete.php?id= <?php echo $dpt['id'] ?>" class="btn btn-danger btn-xs" onclick="return confirm('are you sure!!')">Delete</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
