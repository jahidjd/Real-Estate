...
?>
    ...
    <img class="animation__shake" src="dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
            ...
            $sli = $conn->query("SELECT * FROM slider where id=" . $_GET['id']);
            $slider = $sli->fetch_assoc();
                ...
                <form action="update_slider.php" method="POST" enctype="multipart/form-data">
                    ...
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td>Action URL</td>
                            <td><input type="text" name="a_url" class="form-control" value="<?php echo $slider['action_url'] ?>"></td>
                        </tr>
                        <tr>

                            <td>Title</td>
                            <td>
                                <textarea name="title" id="" cols="15" rows="5" class="form-control"><?php echo $slider['title'] ?></textarea>
                            </td>
                            <td>Brief</td>
                            <td>
                                <textarea name="brief" id="" cols="15" rows="5" class="form-control"><?php echo $slider['brief'] ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>
