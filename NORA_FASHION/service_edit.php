...
?>
    ...
    <img class="animation__shake" src="dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
            ...
            $sr = $conn->query("SELECT * FROM service where id=" . $_GET['id']);
            $service = $sr->fetch_assoc();
            ...
            <div class="container">
                ...
                <form action="update_service.php" method="post" enctype="multipart/form-data">
                    ...
                    <table class="table table-bordered">
                        <tr>
                            <td>Service Title</td>
                            <td><input type="text" name="s_title" class="form-control" value="<?php echo $service['title'] ?>"></td>
                            <td>Service Photo</td>
                        ...
                        <tr>
                            <td>Details</td>
                            <td colspan="3">
                                <textarea name="s_details" id="" cols="30" rows="10" class="form-control"><?php echo $service['details'] ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>Number</td>
                            <td><input type="text" name='number' class="form-control" value="<?php echo $service['number'] ?>"></td>
