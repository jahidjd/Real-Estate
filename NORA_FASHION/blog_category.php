...
?>
    ...
    <img class="animation__shake" src="dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
                ...
                <form action="add_blog_category.php" method="POST">
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td>Blog Name</td>
                            <td><input type="text" name="blog_name" class="form-control"></td>
                        </tr>
                        <tr>
                            <td colspan="4"><input type="submit" class="btn btn-info btn-block" value="Insert"></td>
                        </tr>
                    </table>
                </form>
            </div>
            ...
            $bl = $conn->query("SELECT * FROM blog_category");
            $sl = 0;


            ?>
            <div class="container">
                <h1>Blog Categpry List</h1>
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <?php while ($blog = $bl->fetch_assoc()) { ?>
                            <tr>
                                <td><?php echo ++$sl ?></td>
                                <td><?php echo $blog['blog_category'] ?></td>
                                <td><?php echo $blog['category_name'] ?></td>
                                <td>
                                    <a href="blog_category_edit.php?id=<?php echo $blog['id'] ?>" class="btn btn-success btn-xs ">Edit</a>
                                    <a href="blog_category_delete.php?id=<?php echo $blog['id'] ?>" class="btn btn-danger btn-xs" onclick="return confirm('are you sure!!')">Delete</a>
                                </td>
                            </tr>
                        <?php } ?>
