        ...
        <form action="add_category.php" method="post">
          <table class="table table-bordered">
            ...
            <tr>
              <td>Short Details</td>
              <td colspan="3">
                <textarea name="short_details" id="" cols="30" rows="10" class="form-control"></textarea>
              </td>
            </tr>
            <tr>
          ...
          <tbody>
            <?php while ($data = $d->fetch_assoc()) { ?>
              <tr>
                ...
                <td>
                  <a href="category_edit.php?id=<?php echo $data['id'] ?>" class="btn btn-info">Edit</a>
                  <a href="category_delete.php?id=<?php echo $data['id'] ?>" class="btn btn-danger" onclick="return confirm('are you sure!!')">Delete</a>
                </td>
              </tr>
            <?php } ?>
          </tbody>
